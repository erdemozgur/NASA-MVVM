...
class OpportunityViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        viewModel.load(vehicleName: RoverName.opportunity)
...
extension OpportunityViewController: PhotosViewModelDelegate {
    ...
    @IBAction func editButtonPressed() {
        self.filteredData(viewModel: self.viewModel, collectionView: self.collectionView, vehicleName: RoverName.opportunity)
    }
